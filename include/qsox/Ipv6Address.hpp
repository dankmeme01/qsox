...
public:
    ...
    static const Ipv6Address UNSPECIFIED;

    constexpr Ipv6Address() : m_octets{} {}
    constexpr Ipv6Address(uint8_t a, uint8_t b, uint8_t c, uint8_t d,
                                 uint8_t e, uint8_t f, uint8_t g, uint8_t h,
                                 uint8_t i, uint8_t j, uint8_t k, uint8_t l,
                                 uint8_t m, uint8_t n, uint8_t o, uint8_t p)
        : m_octets{a, b, c, d, e, f, g, h, i, j, k, l, m, n, o, p} {}
    constexpr Ipv6Address(const std::array<uint8_t, 16>& octets) : m_octets(octets) {}
    constexpr Ipv6Address(const Ipv6Address& other) = default;
    constexpr Ipv6Address& operator=(const Ipv6Address& other) = default;
    ...
    constexpr std::strong_ordering operator<=>(const Ipv6Address& rhs) const {
    ...
    constexpr const std::array<uint8_t, 16>& octets() const {
        return m_octets;
    }

    constexpr std::array<uint8_t, 16>& octets() {
        return m_octets;
    }
    ...
    constexpr bool isUniqueLocal() const {
